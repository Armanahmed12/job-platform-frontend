  ...
  return (
    <section className="hero bg-base-200 min-h-[420px]">
      <div className="hero-content flex-col lg:flex-row-reverse gap-10">
        ...
        {/* Visual Section */}
        <div className="w-full lg:w-2/5 flex flex-col items-center justify-center gap-6">
          <motion.img
            src={team1}
        ...
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          ...
          >
            ...
            <motion.span
              animate={{ color: ["#2563eb", "#16a34a", "#dc2626"] }}
          ...
          <p className="py-6 text-lg text-gray-600 max-w-xl mx-auto lg:mx-0">
            Discover verified jobs from trusted companies, apply with confidence,
            and track your career progress — all in one smart and secure job
